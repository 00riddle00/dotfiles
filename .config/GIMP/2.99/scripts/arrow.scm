...
; Date: 2024-04-08 01:14:18 EEST
; Path: ~/.config/GIMP/2.99/scripts/arrow.scm
; URL:  https://github.com/00riddle00/dotfiles
; NB:   This script was written for GIMP 2.x and it worked well for GIMP 2.10.
;       It is not yet tested with GIMP 3.x
;------------------------------------------------------------------------------
; Author: Berengar W. Lehr (Berengar.Lehr@gmx.de)
; Obtained from the author: 2020-02-01 21:00:16 EET
