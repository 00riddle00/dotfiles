...
(gtk_accel_path "<Actions>/terminal-window/next-tab" "<Primary>w")
...
(gtk_accel_path "<Actions>/terminal-window/close-tab" "<Primary>x")
...
(gtk_accel_path "<Actions>/terminal-window/prev-tab" "<Primary>q")
...
(gtk_accel_path "<Actions>/terminal-window/set-title" "F2")
