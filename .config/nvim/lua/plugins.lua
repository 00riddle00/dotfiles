...
return require("packer").startup(function(use)
  ...
  use { "jlanzarotta/bufexplorer",
    config = function() require("plugins/bufexplorer") end }
  ...
  use { "vim-autoformat/vim-autoformat",
    config = function() require("plugins/vim-autoformat") end }
  use { "ryanoasis/vim-devicons" }
  use { "junegunn/vim-easy-align" }
  use { "easymotion/vim-easymotion",
    config = function() require("plugins/vim-easymotion") end }
  use { "houtsnip/vim-emacscommandline",
    config = function() require("plugins/vim-emacscommandline") end }
