...
(function() {
  ...
  LinkHints = {
    activateMode: function(count, mode) {
      if (count == null) {
        count = 1;
      }
      if (mode == null) {
        ...
        return HintCoordinator.prepareToActivateMode(mode, function(isSuccess) {
          if (isSuccess) {
            return Utils.nextTick(function() {
              return LinkHints.activateMode(count - 1, mode);
            });
          }
        });
      }
    ...
    activateModeToOpenInNewTab: function(count) {
      return this.activateMode(count, OPEN_IN_NEW_BG_TAB);
    },
    activateModeToOpenInNewForegroundTab: function(count) {
      return this.activateMode(count, OPEN_IN_NEW_FG_TAB);
    },
    activateModeToCopyLinkUrl: function(count) {
      return this.activateMode(count, COPY_LINK_URL);
    },
    activateModeWithQueue: function() {
      return this.activateMode(1, OPEN_WITH_QUEUE);
    },
    activateModeToOpenIncognito: function(count) {
      return this.activateMode(count, OPEN_INCOGNITO);
    },
    activateModeToDownloadLink: function(count) {
      return this.activateMode(count, DOWNLOAD_LINK_URL);
    }
  };
    ...
    LinkHintsMode.prototype.activateLink = function(linkMatched, userMightOverType) {
          ...
          return function(isSuccess) {
            ...
            if (isSuccess) {
              if (localHintDescriptor.reason === "Frame.") {
                ...
                if (clickEl.nodeName.toLowerCase() === "input" && ((ref1 = clickEl.type) !== "button" && ref1 !== "submit")) {
                  clickEl.focus();
                }
      ...
      installKeyboardBlocker = function(startKeyboardBlocker) {
        ...
        if (linkMatched.isLocalMarker) {
          ...
          HintCoordinator.onExit.push(function() {
  ...
  LocalHints = {
    getVisibleClickable: function(element) {
      var actionName, areas, areasAndRects, clientRect, eventType, i, imgClientRects, isClickable, jsactionRule, jsactionRules, len, map, mapName, namespace, onlyHasTabIndex, possibleFalsePositive, reason, ref, ref1, ref10, ref11, ref12, ref13, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, ruleSplit, tabIndex, tabIndexValue, tagName, visibleElements;
      ...
      if (element.hasAttribute("onclick") || ((ref4 = (ref5 = element.getAttribute("role")) != null ? ref5.toLowerCase() : void 0) === "button" || ref4 === "link") || ((ref6 = (ref7 = element.getAttribute("contentEditable")) != null ? ref7.toLowerCase() : void 0) === "" || ref6 === "contentEditable" || ref6 === "true")) {
        isClickable = true;
      }
      if (!isClickable && element.hasAttribute("jsaction")) {
        ...
        for (i = 0, len = jsactionRules.length; i < len; i++) {
          ...
          if ((1 <= (ref8 = ruleSplit.length) && ref8 <= 2)) {
            ref9 = ruleSplit.length === 1 ? ["click"].concat(slice.call(ruleSplit[0].trim().split(".")), ["_"]) : [ruleSplit[0]].concat(slice.call(ruleSplit[1].trim().split(".")), ["_"]), eventType = ref9[0], namespace = ref9[1], actionName = ref9[2];
      ...
      switch (tagName) {
        ...
        case "textarea":
          ...
          break;
        case "input":
          isClickable || (isClickable = !(((ref10 = element.getAttribute("type")) != null ? ref10.toLowerCase() : void 0) === "hidden" || element.disabled || (element.readOnly && DomUtils.isSelectable(element))));
          break;
        case "button":
        case "select":
        ...
        case "label":
          ...
          break;
        case "body":
          isClickable || (isClickable = element === document.body && !windowIsFocused() && window.innerWidth > 3 && window.innerHeight > 3 && ((ref11 = document.body) != null ? ref11.tagName.toLowerCase() : void 0) !== "frameset" ? reason = "Frame." : void 0);
          isClickable || (isClickable = element === document.body && windowIsFocused() && Scroller.isScrollableElement(element) ? reason = "Scroll." : void 0);
          break;
        case "img":
          isClickable || (isClickable = (ref12 = element.style.cursor) === "zoom-in" || ref12 === "zoom-out");
          break;
        case "div":
        case "ol":
        case "ul":
      ...
      if (!isClickable && 0 <= ((ref13 = element.getAttribute("class")) != null ? ref13.toLowerCase().indexOf("button") : void 0)) {
    ...
    getLocalHints: function(requireHref) {
      var descendantsToCheck, element, elements, hint, i, k, l, len, len1, len2, localHints, negativeRect, nonOverlappingElements, position, rects, ref, visibleElement, visibleElements;
      if (!document.documentElement) {
        return [];
      }
