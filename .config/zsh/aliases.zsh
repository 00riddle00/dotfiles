...
alias wpah='sudo wpa_supplicant -B -i wlp4s0 -c /etc/wpa_supplicant/home.conf'
...
alias pra='cd $HOME/Tomas_Giedraitis/practice/'
alias prac='pra; vim $HOME/Tomas_Giedraitis/practice/practice_presentation.tex'
