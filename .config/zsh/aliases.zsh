...
def aucmd   '${EDITOR} ${XDG_CONFIG_HOME}/nvim/lua/config/autocmd.lua'
...
def r   'yazi'
def be  '${EDITOR} ${PRO}/cmspilot-eval/BENCHMARK.md'
def arch '${EDITOR} ${NOTES}/coding/wiki/arch_install.md'
