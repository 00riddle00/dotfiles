...
alias vr='vim $HOME/.config/vim/vimrc'
...
# Mixed connections (DisplayPort + HDMI)
# ------------------------------------------------------
...
# 3 Monitors
# =========================================
# Mixed connections (HDMI + DisplayPort + DisplayPort)
# ------------------------------------------------------
...
alias xport.1080='x.hdmi.port.dp1.1080.dp2.port; rewallpaper'
alias xport.1440='x.hdmi.port.dp1.1440.dp2.port; rewallpaper'
...
alias wpav='sudo wpa_supplicant -B -i wlp8s0 -c /etc/wpa_supplicant/vero-cafe.conf'
...
alias v2='cd /home/riddle/Tomas_Giedraitis/experiments/cod_melting_points/weka_ann_classifier/classifiers/melting_points_5_classes/v.2'
...
alias v5='cd /home/riddle/Tomas_Giedraitis/experiments/cod_melting_points/weka_ann_classifier/classifiers/melting_points_5_classes/v.5'
...
alias ccpc='ccp; vim $HOME/Tomas_Giedraitis/course_project/course_project.tex'
...
alias res='vim outputs/weka_run_mlp.out'
alias clas='vim input_vectors_with_classes.com'
alias m3='cd /home/riddle/Tomas_Giedraitis/experiments/cod_melting_points/weka_ann_classifier/classifiers/melting_points_3_classes'
alias m4='cd /home/riddle/Tomas_Giedraitis/experiments/cod_melting_points/weka_ann_classifier/classifiers/melting_points_4_classes'
alias rez='cd /home/riddle/.local/share/tmux/resurrect'
alias dec.on='export INCLUDE_DECOMPOSITION=1'
alias dec.off='unset INCLUDE_DECOMPOSITION'
alias dee='echo $INCLUDE_DECOMPOSITION'
alias e.weka='vim weka_run_mlp.com'
alias e.split='vim input_vectors_with_classes.com'
alias e.restore='cp orig.weka_run_mlp.com weka_run_mlp.com'
...
alias pps='cd $HOME/pro/2023/problem-solving/Codewars'
alias lw='wl'
alias vig='cd $HOME/pro/2023/PTUA6'
alias ptu='cd $HOME/pro/2022/CodeAcademy/PTUA6'
alias mime='vim /home/riddle/.config/mimeapps.list'
alias sol='cd /home/riddle/pro/2023/PTUA6/Tomas_Giedraitis/Solutions_to_problems'
alias prob='cd /home/riddle/pro/2023/PTUA6/Problems'
alias op='cd ~/.config/openbox'
alias priv='cd ~/Downloads/CodeAcademy-Python-Course-Private/'
alias vif='cd /home/riddle/pro/2023/PTUA6/Tomas_Giedraitis/Solutions_to_problems/Flask/'
...
alias fla='cd /home/riddle/pro/2023/PTUA6/Tomas_Giedraitis/Solutions_to_problems/Flask'
alias ser='cd /home/riddle/pro/2023/PTUA6/Tomas_Giedraitis/Solutions_to_problems/Django/car_service'
alias aser='cd /home/riddle/pro/2023/PTUA6/Tomas_Giedraitis/Solutions_to_problems/Django/auto_service'
alias aser2='cd /home/riddle/Downloads/auto_service'
alias hist='cd $HOME/histfiles/'
alias tre='tree -I "venv|__pycache__"'
alias wik='cd $DOWNLOADS/wikis/'
alias confi='cd .config'
alias enc='uchardet'
alias wikis='cd /home/riddle/Downloads/wikis'
alias blo='cd /home/riddle/Downloads/blog-with-django'
alias tren='crystal_property_predictor train -c experiments/config.yml'
alias trem='crystal_property_predictor train -c experiments/mnist/config.yml'
alias gitconf='vim $XDG_CONFIG_HOME/git/config'
alias mp9='cd $HOME/tmp9'

alias startx='startx 2> ~/.X.err 1> ~/.X.out &'
#alias cp='cp -i'
#alias mv='mv -i'
alias ducks='du -chs -- * | sort -h -k1,1'
alias path='echo $PATH | tr ":" "\n"'
# display only directories:
#alias dod='\ls -l | grep ^d'
# display only directories (colorls):
alias dod='colorls -ld'
# display only files:
#alias dof='\ls -l | grep ^-'
# display only files (colorls):
...
alias lm='ls -l | more'
alias 10='cd /home/riddle/pro/2023/problem-solving/Codewars/temp/bucket_10'
alias omp='cd /home/riddle/Tomas_Giedraitis/experiments/cod_melting_points/OMP_dataset'
alias pyt='cd /home/riddle/Tomas_Giedraitis/experiments/cod_melting_points/pytorch_ann_predictor'
alias p11='cd /home/riddle/PTUA11'
alias pred='cd /home/riddle/Tomas_Giedraitis/experiments/cod_melting_points/pytorch_ann_predictor/predictor'
