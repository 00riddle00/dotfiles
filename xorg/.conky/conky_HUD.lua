...
gauge = {
{
    ...
    graph_bg_colour=0x0077ff,      graph_bg_alpha=0.3,
    graph_fg_colour=0x0077ff,      graph_fg_alpha=0.0,
    hand_fg_colour=0x0077ff,       hand_fg_alpha=1.0,
    txt_radius=40,
    txt_weight=1,                  txt_size=10.0,
    txt_fg_colour=0x0077ff,        txt_fg_alpha=0.8,
    graduation_radius=30,
    graduation_thickness=0,        graduation_mark_thickness=1,
    graduation_unit_angle=27,
    graduation_fg_colour=0x0077ff, graduation_fg_alpha=0.3,
    caption='',
    caption_weight=1,              caption_size=8.0,
    caption_fg_colour=0x0077ff,    caption_fg_alpha=0.3,
},
{
...
},
{
    ...
    caption_fg_colour=0x0077ff,    caption_fg_alpha=0.5,
},
{
